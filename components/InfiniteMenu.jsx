      ...
      {activeItem && (
        <>
          <div
            ...
            `}
          >
            <h2 className="select-none font-black text-3xl md:text-5xl text-white leading-tight">
              {activeItem.title}
            </h2>
            <p className="select-none text-sm md:text-base text-white/80 leading-relaxed">
          ...
          <div className={buttonContainerClasses}>
            {hasLive && (
              <div
                onClick={() => openLink(activeItem.live || activeItem.link)}
            ...
            {hasGithub && (
              <div
                onClick={() => openLink(activeItem.github)}
                className={buttonBaseClasses}
            ...
            {!hasLive && !hasGithub && (activeItem?.link) && (
              <div
                onClick={() => openLink(activeItem.link)}
                className={buttonBaseClasses}
                title="Abrir link"
              >
                <p className="select-none relative top-[2px] text-[26px]">&#x2197;</p>
              </div>
            )}
          </div>
        </>
